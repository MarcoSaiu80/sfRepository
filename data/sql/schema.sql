...
CREATE TABLE indirizzo (id BIGINT AUTO_INCREMENT, via TEXT, indirizzo_id TEXT, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE utenti (id BIGINT AUTO_INCREMENT, nome TEXT, cognome TEXT, INDEX indirizzo_id_idx (indirizzo_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE utenti ADD CONSTRAINT utenti_indirizzo_id_indirizzo_id FOREIGN KEY (indirizzo_id) REFERENCES indirizzo(id);
